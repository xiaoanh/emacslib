...
#+BEGIN_SRC emacs-lisp 
        ...
        (setq org-dir (expand-file-name "lisp" (expand-file-name "org-mode-master" path-to)))
        (setq org-contrib-dir (expand-file-name "lisp" (expand-file-name "contrib"  (expand-file-name "org-mode-master" path-to)))) 
  ...
  (global-set-key (kbd "C-c i")
                  (lambda() (interactive) (org-babel-load-file (concat path-to "dotemacsw.org"))))
        ;;; init.el ends here
...
* @debug [2015-12-28]
** org-babel-load-file kbd+lambda
   1. Emacs init file written in org-mode
